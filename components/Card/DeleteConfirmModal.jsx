...
export default function DeleteConfirmModal({ onConfirm, onCancel, title = "Delete Item", description = "Are you sure you want to delete this? This action cannot be undone." }) {
  return (
